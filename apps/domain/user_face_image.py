...
class UserFaceImage:
    def __init__(self):
        ...
        self.original = ""
        self.data_original_as_base64 = ""

        self.genre = ""
        self.genre_percentage_detail = {}
        self.feature = [] #特徴量
        self.dimension = 0

    def extract_face(self):
        service = ext.ExtractFaceService()
        self.data_as_base64 = service.execute(self.data_original_as_base64)
        return self

    def apply_to_classifier(self):
        service = det.DetermineGenreService()
        self.genre,self.genre_percentage_detail = service.execute(self.data_as_base64)
        return self
